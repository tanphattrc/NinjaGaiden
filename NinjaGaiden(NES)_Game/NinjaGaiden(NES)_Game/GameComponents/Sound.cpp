...
void Sound::play(std::string name, bool infiniteLoop, int times, int dwFlag)
{
	if (isMute)
	{
		return;
...
{
	loadSound("Resources/Sound/Injured.wav", "Injured");
	loadSound("Resources/Sound/PickItem.wav", "PickItem");
    loadSound("Resources/Sound/Beat.wav", "Beat");
	loadSound("Resources/Sound/Jump.wav", "Jump");
	loadSound("Resources/Sound/BonusHP.wav", "BonusHP");
	loadSound("Resources/Sound/FireWeapon.wav", "FireWeapon");
	loadSound("Resources/Sound/WindmillStarWeapon.wav", "WinmillStarWeapon");
	loadSound("Resources/Sound/ThrowingStarWeapon.wav", "ThrowingStarWeapon");
    loadSound("Resources/Sound/BeatEnemy.wav", "BeatEnemy");
	loadSound("Resources/Sound/Death.wav", "Death");
	loadSound("Resources/Sound/Level1.wav", "Level1");
	loadSound("Resources/Sound/Level2.wav", "Level2");
